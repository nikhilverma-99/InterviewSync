...
const Register = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      success(`${formData?.businessName} has been Registered Successfully !`);
      navigate("/plans");
    } catch (err) {
      console.log(err);
      error(err.message);
      ...
      <form className="form-registration">
        ...
        {isLoading ? (
          <div
            ...
            style={{ backgroundColor: "#45be41" }}
          >
            <LoadingIcons.Oval style={{ height: "140%" }} />
          </div>
        ) : (
          <div
            className="registration-btn"
  ...
  return (
    <div className="getStarted-container">
      ...
      <main className="main">
        ...
        <aside
          className="getStarted-aside"
          style={{ zIndex: 1000, paddingLeft: "4.4rem" }}
        >
